...
public class RabbitSpawnManager : MonoBehaviour
{
    ...
    void Start()
    {
        points = GameObject.Find("RabbitSpawnPointGroup").GetComponentsInChildren<Transform>();
    ...
    IEnumerator CreateAnimal()
    {
        ...
        {
            // 현재 생성된 동물 개수 산출
            int animalCount = (int)GameObject.FindGameObjectsWithTag("Rabbit").Length;      // 나중에 수정
