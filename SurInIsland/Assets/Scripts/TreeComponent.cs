...
public class TreeComponent : MonoBehaviour
{
    ...
    [SerializeField]
    private AudioClip tree_chop_sound;
    [SerializeField]
    private AudioClip tree_falldown_sound;
    [SerializeField]
    private AudioClip tree_log_sound;
    ...
    {
        audioSource.clip = tree_chop_sound;
        audioSource.Play();
    ...
    {
        audioSource.clip = tree_falldown_sound;
        audioSource.Play();
    ...
    IEnumerator LogCoroutine()
    {
        ...
        audioSource.clip = tree_log_sound;
        audioSource.Play();
